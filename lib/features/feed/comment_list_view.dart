// lib/features/feed/comment_list_view.dart
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (docs.isEmpty) {
          return const Center(
            child: Text('İlk yorumu sen yap!', style: TextStyle(color: Colors.white54)),
          );
        }
            ...
            return Container(
              ...
              decoration: isStickerComment
                  ? BoxDecoration(
                      ...
                      border: Border.all(color: const Color(0xFFFF5E00).withOpacity(0.5), width: 1),
                      boxShadow: [
                        BoxShadow(
              ...
              child: ListTile(
                leading: const CircleAvatar(
                  ...
                  child: Icon(Icons.person, color: Color(0xFF8E92B2), size: 20),
                ),
                title: Text(
                  username,
                  style: TextStyle(
                    color: isStickerComment ? const Color(0xFFFF5E00) : const Color(0xFF8E92B2),
                    fontSize: 12,
                    fontWeight: isStickerComment ? FontWeight.bold : FontWeight.normal,
                  ),
                ),
                subtitle: Row(
                  children: [
