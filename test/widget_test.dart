...
import 'package:hexa/app/hexa_app.dart';

void main() {
  testWidgets('Hexa app shell renders with an overridden test router', (
    WidgetTester tester,
  ) async {
        ...
        GoRoute(
          ...
          builder: (context, state) {
            return const Scaffold(
              body: Center(
                child: Text('HEXA_TEST_HOME', key: Key('hexa-test-home')),
              ),
            );
          },
        ),
